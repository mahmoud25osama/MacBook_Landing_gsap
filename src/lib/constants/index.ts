...
const performanceImages: performImgType[] = [
...
const performanceImgPositions: performImgPositionsType[] = [
    {
        id: 'p1',
        left: 5,
        bottom: 65,
...
const featureSequence: featureSeqType[] = [
